...
<div style="padding: 10px;">
    <button type="button" class="btn btn-primary" onclick="ShowContent('modules/roles/addNewRol.php');">AGREGAR NUEVO
        ROL</button>
    <button type="button" class="btn btn-secondary" data-bs-target="#formNewUser" data-bs-toggle="modal">AGREGAR NUEVO
        USUARIO</button>
</div>
